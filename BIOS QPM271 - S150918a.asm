...
; CHANGELOG:
;
; S150918/A         First revision / Added changes from CPM2.2 S030818-R120923         
;                   Changed CONST_ and CONIN_ to allow full 8 bit data I/O.
;                   Added CONST MODE to select 7 or 8 bit mode (for XMODEM).
;                   Added support for the SPP Adapter board (A240721-R270921 and
...
BOOT_
    ...
    call    puts
    ld      hl, QPMMsg      ; Print QP/M 2.71 message
    call    puts            ;	
    ;
...
BiosMsg     .db     cr, lf, lf, "Z80-MBC2 QP/M 2.71 BIOS - S150918A", cr, lf, eos
CRLFLF      .db     cr, lf, lf, eos
QPMMsg      .db     "QP/M 2.71 Copyright 1985 (c) by MICROCode Consulting", cr, lf, eos
